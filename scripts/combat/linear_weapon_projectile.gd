class_name LinearWeaponProjectile
extends WeaponHitSource

## Moves one detached weapon hit source through world space and reports its first enemy collision.
## Concrete scenes own artwork and collision shape; weapon statistics remain in WeaponData.
...
## Starts movement along a normalized world-space direction.
